      ...
      {showSupportModal && (
        ...
        >
          <div className={`relative p-6 rounded-lg w-96 lg:w-[600px] bg-secondary max-h-[90vh] overflow-y-auto ${className}`}>
            ...
            <hr className=" border-gray-500 border-opacity-35" />
            ...
            {supportLinks.length > 0 ? (
                ...
                <div>
                  ...
                  {!formSubmitted && (
                    <form
                      ...
                      <div className=" text-white lg:flex justify-between items-center my-2 pb-3 font-bold">
                      ...
                      <div className="mb-4 mt-12">
                        ...
                        <select
                          ...
                          className="w-full p-2 focus:outline-none bg-zinc-800 bg-opacity-20 py-3 rounded   text-white">
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          className="w-full p-2 bg-zinc-800 focus:outline-none bg-opacity-20 rounded  text-white"></textarea>
              ...
              ${
                isButtonActive ? "bg-white" : "bg-gray-300 cursor-not-allowed"
              }`}>
                        ...
                        <div key={links._id}>
                          <p className="text-center p-2 text-white">
                            <span className=" text-primary">
                              Instructor name:{" "}
                              <span className="text-primary">
                                {links.instructorName}
                              </span>{" "}
                            </span>
                          </p>
                          <div className=" flex justify-center bg-zinc-800 bg-opacity-20 w-fit h-fit my-4 rounded-md mx-auto">
                            <Image
                              src={sup}
                              alt="Logo"
                              width={100}
                          ...
                          <hr className=" border-gray-600 bg-opacity-20 my-3" />
                          ...
                          <p className=" text-center">
                            <span className=" text-gray-300 font-bold">
                              Your turn will come about{" "}
                              <span className=" ">{issues.length * 5}</span>{" "}
                              minutes later. Please stay connected
                            </span>
                          </p>
                          <hr className=" border-gray-600 bg-opacity-20 mt-3" />
                          ...
                          <div className="flex justify-center mt-8">
                            ...
                            <div>
                              <Link href={links.meetLink}>
                                <Button className="px-4 py-1 bg-white font-bold text-black rounded-md hover:bg-gray-300 mx-2">
                                  Join Now
                                </Button>
                              </Link>
                            </div>
