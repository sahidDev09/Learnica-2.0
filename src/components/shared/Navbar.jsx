...
const Navbar = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      if (currUser) {
        try {
          const response = await fetch(`/api/users/user?email=${currUser}`);
  ...
  useEffect(() => {
    ...
    const fetchOrders = async () => {
      if (currUser) {
        try {
          const response = await fetch(`/api/get-orders?email=${currUser}`);
          const data = await response.json();
  ...
  return (
    <>
                          ...
                          <div className="flex flex-col h-full">
                            <SheetHeader className="p-6 pb-0">
                              ...
                              <SheetDescription className="text-xs text-zinc-500">
                                Ask anything about our courses, platforms, or
      ...
      <div
        className={`${
          openMenu ? "w-full" : "w-0"
        } fixed top-0 right-0 h-full bg-[#135276] transition-all overflow-hidden z-[100]`}
      >
        ...
        <ul className="text-white font-semibold p-4 space-y-4">
          ...
          <li>
            <Link href="/all-courses" className="hover:font-bold">
              Courses
            </Link>
          </li>
          <li className="">
          ...
          <ExpandableScreen layoutId="helpline-mobile">
            <li className="hover:font-bold">
              <ExpandableScreenTrigger>Helpline</ExpandableScreenTrigger>
            </li>
            <ExpandableScreenContent className="z-[100]">
              <HelplineContent user={user} />
            </ExpandableScreenContent>
          ...
          <div className="relative bg-white dark:bg-zinc-900 rounded-[2.5rem] p-10 max-w-sm w-full shadow-2xl border border-white/20 transform transition-all duration-300 ease-out animate-in zoom-in-95 fade-in">
            <div className="flex flex-col items-center text-center mb-10">
              ...
              <p className="text-zinc-500 dark:text-zinc-400 font-medium">
                Where you wanna Enter please select
              </p>
            </div>
            ...
            <div className="grid gap-5">
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-bold text-white uppercase tracking-widest text-xs opacity-80 mb-1">
                    Enter as
                  </p>
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest text-xs mb-1">
                    Enter as
                  </p>
