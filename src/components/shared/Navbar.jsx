...
const Navbar = () => {
  ...
  return (
    <nav className="bg-secondary">
      ...
      {!formSubmitted && (
        <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-white pt-2 ">
          <div className=' lg:flex justify-between pb-3 font-bold'>
              <p className='font-bold'>Ongoing Support Session</p>
              <p>Session Time : <span className='text-purple-800'>9:00 PM</span> to <span className='text-purple-800'>11:00 PM</span></p>
            </div>
            <hr  className=' pt-3'/>
          <h2 className="text-2xl font-bold mb-4 text-center"><span className=' text-green-500'>To get support,</span> <span className=' text-orange-500'>Submit Your Issue first</span></h2>

          {/* Dropdown for selecting option */}
          <div className="mb-4">
            <label htmlFor="issue-type" className="block text-gray-700 mb-2">
              Select Issue Type<span className='text-orange-500'>*</span>
            </label>
            <select
              id="issue-type"
          ...
          <div className="mb-4">
            <label htmlFor="issue-description" className="block text-gray-700 mb-2">
              Describe Your Issue (1-250 characters)<span className='text-orange-500'>*</span>
            </label>
            <textarea
              ...
              className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring focus:ring-indigo-500"
            ></textarea>
            <p className="text-right text-sm text-gray-600 mt-1">{issueText.length}/250 characters</p>
            {showWarning && (
              <p className="text-red-500 text-sm mt-2">Type at least 20 characters</p>
            )}
          </div>
          ...
          <div className="flex justify-between">
            <button
              ...
              ${isButtonActive ? 'bg-indigo-500 hover:bg-indigo-600' : 'bg-gray-300 cursor-not-allowed'}`}
            >
      ...
      {formSubmitted && (
        <div>
          ...
          <p className='text-center p-2'><span>Instructor name: <span>Numan</span> </span></p>
          <hr />
          <p className='text-center p-2'><span>Your Serial No: <span>10</span> </span></p>
          <hr />
           <h1 className='text-center p-2'>To get support join quickly</h1>
        <div className="flex justify-center mt-8">
         ...
         <div><Link href='https://meet.google.com/wou-cmvs-qsa'> <button
...
{/* if there has no support session */}
    ...
    <div className="mt-4">
      <h3 className="text-xl p-1 font-bold text-center bg-slate-200 text-green-600">Daily Support Session Time</h3>
