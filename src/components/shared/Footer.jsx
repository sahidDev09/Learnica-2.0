  ...
  return (
    <div>
      <footer className=" bg-blue-500  mt-6">
        <div
          className=" lg:flex md:flex lg:justify-between md:justify-between md:pr-10 p-6
">
          <div className=" lg:ml-12">
            <Image
              className="md:w-60 lg:w-80 mb-5"
              src={logo}
              alt="logo"></Image>
          </div>
        ...
        <div className=" pb-3 -mt-3 text-center">
          <h2 className=" text-center text-[30px] text-white font-bold">
            Web Warriors
          </h2>
