...
import { Calendar, User, Tag, Video, ExternalLink } from "lucide-react";
          ...
          >
            ...
            <div className="flex flex-col flex-grow p-5">
              ...
              <div className="mt-5 pt-4 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center">
                <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">Live Session</span>
                <Link href={liveClass.liveLink} target="_blank">
